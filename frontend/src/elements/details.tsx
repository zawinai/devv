...
const Details = () => {
  return (
    <div className='mt-[100px] max-w-[1200px] grid grid-cols-1 md:grid-cols-10 place-content-center mx-auto z-0'>
      <section className='col-start-1 col-end-3 bg-slate-200 hidden md:flex text-center py-10 px-4'>Table Contents</section>
      <main className='mt-[300px] col-start-4 col-end-10'>
        <div className='mb-4 md:mb-0 w-full max-w-screen-md mx-auto relative'>
          ...
          <div className='p-4 absolute bottom-0 left-0 '>
            <h2 className='text-4xl font-semibold text-gray-800 leading-tight  mb-[60px]'>
